...
Singleton {
    ...
    component Width: QtObject {
        ...
        readonly property int smaller: 30
        readonly property int medium: 45
        readonly property int larger: 60
        readonly property int large: 70
    }
    ...
    component Rounding: QtObject {
        ...
        readonly property int normal: 9
